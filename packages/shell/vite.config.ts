  ...
  plugins: [
    ...
    federation({
      ...
      remotes: {
        ...
        favoritesMFE: process.env.VITE_STATIC_MFE_URL || 'http://localhost:3005/assets/remoteEntry.js',
        commentsMFE: process.env.VITE_STATIC_MFE_URL || 'http://localhost:3007/assets/remoteEntry.js',
